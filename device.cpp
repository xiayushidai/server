...
QVector<Device*> Device::s_devices; //定义设备数组。
...
Device::Device(libinput_device *device, QObject *parent)   //构造函数
    : QObject(parent)
    , m_device(device) //初始化成员变量。
...
#undef CONFIG   //取消定义CONFIG，后面重新定义。
